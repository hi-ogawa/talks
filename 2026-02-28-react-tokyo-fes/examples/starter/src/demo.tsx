...
async function demo5() {
  ...
  // Simulate rendering following react node
  const reactNode = (
    <CachedParent>
      <DynamicChild />
    </CachedParent>
  );
  console.log("==== React tree (original) ====");
  console.dir(reactNode, { depth: null });
  console.log();
...
export async function main(args: string[]) {
  ...
  const demoFn = { demo1, demo2, demo3, demo4, demo5 }[command];
  if (!demoFn) {
